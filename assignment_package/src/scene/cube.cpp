...
void createInterleavedCube(glm::vec4 (&cub_vert_pos)[CUB_VERT_COUNT * 3], GLuint (&cub_idx)[CUB_IDX_COUNT]) {
    ...
    //UR
    cub_vert_pos[idx++] = glm::vec4(0.5f, 0.5f, 0.5f, 1.0f);
    cub_vert_pos[idx++] = glm::vec4(0,0,1,0);
    cub_vert_pos[idx++] = glm::vec4(0.2f, 1.0f, 0.6f, 1);
    //LR
    cub_vert_pos[idx++] = glm::vec4(0.5f, -0.5f, 0.5f, 1.0f);
    cub_vert_pos[idx++] = glm::vec4(0,0,1,0);
    cub_vert_pos[idx++] = glm::vec4(0.2f, 1.0f, 0.6f, 1);
    ...
    //UR
    cub_vert_pos[idx++] = glm::vec4(0.5f, 0.5f, -0.5f, 1.0f);
    cub_vert_pos[idx++] = glm::vec4(1,0,0,0);
    cub_vert_pos[idx++] = glm::vec4(0.2f, 1.0f, 0.6f, 1);
    ...
    //UR
    cub_vert_pos[idx++] = glm::vec4(0.5f, 0.5f, -0.5f, 1.0f);
    cub_vert_pos[idx++] = glm::vec4(0,1,0,0);
    cub_vert_pos[idx++] = glm::vec4(0.2f, 1.0f, 0.6f, 1);
...
void Cube::create()
{
    ...
    glm::vec4 cub_vert_inter[CUB_VERT_COUNT * 3];

    createInterleavedCube(cub_vert_inter,sph_idx);
    ...
    context->glBufferData(GL_ARRAY_BUFFER, CUB_VERT_COUNT * 3 * sizeof(glm::vec4), cub_vert_inter, GL_STATIC_DRAW);
